...
public class SellFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mButtonUpload = v.findViewById(R.id.buttonUpload);
        mEditTextFileName = v.findViewById(R.id.editTextFileName);
        mEditTextFilePrice = v.findViewById(R.id.editTextFilePrice);
        mImageView = v.findViewById(R.id.imageView);
        mProgressBar = v.findViewById(R.id.progressBar);
        mDescription = v.findViewById(R.id.Description);
        mStorageRef = FirebaseStorage.getInstance().getReference("productUploadData");
